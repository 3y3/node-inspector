 ...
 */
function main() {
  config = createConfig(process.argv);
  if (config.options.help) {
    Config.printHelpAndExit(config.options.help, config.options.l);
  }
...
function createConfig(argv) {
  var options = new Config(argv.slice(2));
