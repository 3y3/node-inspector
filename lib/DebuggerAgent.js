...
DebuggerAgent.prototype.injection = function(require, debug, options) {
  ...
  function wrapCallFrames(execState, maximumLimit, scopeDetails, DebuggerScript) {
    ...
    do {
      ...
      callFrame.sourceID = callFrame.sourceID();
      callFrame.line = callFrame.line();
      callFrame.column = callFrame.column();
      callFrame.scopeChain = callFrame.scopeChain();
